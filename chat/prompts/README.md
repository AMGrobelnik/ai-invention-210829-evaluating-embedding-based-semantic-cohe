...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_plan/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_1.md` — 17 prompts
  ...
  - round_2
    ...
    - `2_gen_plan/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_experiment_1.md` — 9 prompts
