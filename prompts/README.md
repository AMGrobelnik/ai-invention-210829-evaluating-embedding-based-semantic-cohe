...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_plan/` — 3 task(s)
      ...
      - `prompts/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_1.md` — 6 prompt(s)
      - `prompts/2_test_idea/round_1/2_gen_plan/gen_plan_research_1.md` — 4 prompt(s)
    - `3_gen_art/` — 3 task(s)
      - `prompts/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 9 prompt(s)
  ...
  - round_2
    - `prompts/2_test_idea/round_2/1_gen_strat.md` — 4 prompt(s)
    - `2_gen_plan/` — 3 task(s)
      - `prompts/2_test_idea/round_2/2_gen_plan/gen_plan_evaluation_1.md` — 5 prompt(s)
      - `prompts/2_test_idea/round_2/2_gen_plan/gen_plan_experiment_1.md` — 8 prompt(s)
      - `prompts/2_test_idea/round_2/2_gen_plan/gen_plan_research_1.md` — 5 prompt(s)
    - `3_gen_art/` — 3 task(s)
      - `prompts/2_test_idea/round_2/3_gen_art/gen_art_evaluation_1.md` — 9 prompt(s)
      - `prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 15 prompt(s)
...
- **3. report_results** — `gen_paper_repo`
  ...
  - `prompts/3_report_results/3_gen_full_paper.md` — 5 prompt(s)
